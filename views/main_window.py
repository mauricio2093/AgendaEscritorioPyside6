...
class MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet(u"QWidget{border-radius:12px;}")
...
"")
        ...
        self.verticalLayout_2.addWidget(self.action_bar_frame)
...
"}")
        ...
        palette1 = QPalette()
        brush2 = QBrush(QColor(220, 220, 220, 255))
        brush2.setStyle(Qt.SolidPattern)
        palette1.setBrush(QPalette.Active, QPalette.WindowText, brush2)
        brush3 = QBrush(QColor(53, 53, 53, 255))
        ...
        brush7 = QBrush(QColor(43, 6, 77, 255))
        ...
        brush17 = QBrush(QColor(255, 17, 80, 255))#modificado señalizacion
        ...
        brush9 = QBrush(QColor(0, 0, 255, 255))
        ...
        brush11 = QBrush(QColor(43, 6, 77, 255))
        ...
        brush14 = QBrush(QColor(220, 220, 220, 128))
...
"}")
        ...
        self.verticalLayout_2.addWidget(self.container_table)

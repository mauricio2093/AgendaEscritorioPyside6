...
from views.recipe_details_window import DetailWidget
from views.general_custom_ui import GeneralCustomUi

from database import recipes

class DetailWindowForm(QWidget, DetailWidget):
    ...
    def fill_widget(self):
        ...
        self.ingredient_TextEdit.setPlainText(ingredients)
        self.direction_TextEdit.setPlainText(directions)
